...
const InventoryUnitsEditById = () => {
  ...
  // Pre-fill form with existing unit data (in a real app, this would come from an API)
  React.useEffect(() => {
    // Simulating data fetching - setting the unit name to "KG" as shown in the image
    setValue("name", "KG");
  }, [setValue]);
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-yellow-200 to-yellow-400 border-b border-gray-200">
          ...
          <p className="text-gray-700 mt-1">
            Update the details below for this unit
          </p>
        </div>
