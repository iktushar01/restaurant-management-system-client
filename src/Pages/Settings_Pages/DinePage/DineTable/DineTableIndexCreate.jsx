    ...
    <div className="max-w-4xl min-h-screen mx-auto p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-yellow-200 to-yellow-400 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800">Add Table</h2>
          <p className="text-gray-700 mt-1">Fill in the details below to add a new table</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input type="text" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-300 outline-none" placeholder="e.g., A1, KABIN 1"
                {...register("tableNo", { required: "Table number is required" })} />
              {errors.tableNo && <p className="mt-1 text-sm text-red-600">{errors.tableNo.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Capacity</label>
              <input type="number" min="1" max="20" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-300 outline-none"
          ...
          <div className="mt-8 flex justify-end space-x-3">
            <Link to="/WorkPeriod/dine/tables" className="px-5 py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">Close</Link>
