...
const ExpenseHeadCreate = () => {
  ...
  const onSubmit = (data) => {
    console.log("Expense Head Form Data:", data);
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-yellow-200 to-yellow-400 border-b border-gray-200">
          ...
          <p className="text-gray-700 mt-1">
            Fill in the details below to create a new Expense Heading
          </p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {/* Expense Head Name Input */}
            ...
            <div className="md:col-span-2">
              <FormInput
                label="Description"
                placeholder="e.g., Monthly office supplies budget"
                name="description"
                register={register}
                rules={{
