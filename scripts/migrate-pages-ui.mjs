...
const replacements = [
  ...
  [/p-6 max-w-6xl min-h-screen mx-auto/g, "max-w-6xl mx-auto"],
  [/p-6 max-w-7xl min-h-screen mx-auto/g, "max-w-7xl mx-auto"],
  [/max-w-7xl min-h-screen mx-auto p-6/g, "max-w-7xl mx-auto"],
