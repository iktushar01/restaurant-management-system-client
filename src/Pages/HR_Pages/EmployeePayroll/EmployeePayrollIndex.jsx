...
const EmployeePayrollIndex = () => {
        ...
        <div className="flex justify-center">
          <span
            className={`h-5 w-5 rounded-full flex items-center justify-center ${
              row.access ? "bg-success" : "bg-muted"
            }`}
          >
    ...
    },
    {
      ...
      render: (row) => (
        <Link
          ...
          className="flex items-center px-2 py-1 rounded text-xs transition-colors bg-accent text-accent-foreground hover:bg-purple-200"
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      {/* Header Section */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-xl shadow-sm border border-border">
        <div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <Link to="Create" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto flex items-center justify-center px-4 sm:px-6 py-2.5 bg-gradient-to-r bg-primary text-primary-foreground font-medium rounded-lg hover:bg-primary/90 transition-all duration-200 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus-visible:ring-ring focus:ring-offset-2 cursor-pointer text-sm sm:text-base">
