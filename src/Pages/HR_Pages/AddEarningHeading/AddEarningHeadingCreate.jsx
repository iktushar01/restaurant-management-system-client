    ...
    <div className="max-w-6xl min-h-screen mx-auto p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-yellow-200 to-yellow-400 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800">Add Earning Head</h2>
          <p className="text-gray-700 mt-1">
            Fill in the details below to create a new earning head
          </p>
        </div>
...
export default AddEarningHeadingCreate;
