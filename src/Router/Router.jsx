...
import InventoryStockLocationIndex from "../Pages/Settings_Pages/InventoryPages/InventoryStockLocation/InventoryStockLocationIndex";
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element:<InventoryHomeMoveStock/>
      },
      {
        path:"/inventory/locate/:id",
        element:<InventoryHomeLocateById/>
      },
      {
  ...
  //=================================
  {
    ...
    children: [
      ...
      //================================
      {
        ...
        element: <InventoryVendorsIndex/>
      },
      {
        path: "/WorkPeriod/inventory/vendors/create",
        element: <InventoryVendorsCreate/>
      },
      {
      ...
      //==============================
      {
        ...
        element: <InventoryStockLocationIndex/>
      },
      {
        path:"/WorkPeriod/inventory/stock-locations/create",
        element: <InventoryStockLocationCreate/>
      },
      {
        path:"/WorkPeriod/inventory/stock-locations/edit/:id",
        element:<InventoryStockLocationEditById/>
      },
      //===============================
      {
      ...
      {
        path:"/WorkPeriod/inventory/sub-category/edit/:id",
        element: <SubCategoryEditByID/>
      },
      //===============================
      {
        path:"/WorkPeriod/inventory/category",
        element:<CategoryPagesIndex/>
      },
      {
        path:"/WorkPeriod/inventory/category/create",
        element:<CategoryPagesCreate/>
      },
       {
