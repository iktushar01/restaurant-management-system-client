          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-foreground mb-1">
                Earning Head Name <span className="text-destructive">*</span>
              </label>
              <select
                {...register("headId", { required: "Earning head is required" })}
                className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus-visible:ring-ring focus-visible:border-ring ${errors.headId ? "border-destructive" : "border-border"}`}
              >
