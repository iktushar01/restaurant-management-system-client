...
const EmployeePayrollEarningIndex = () => {
  ...
  const [earningData, setEarningData] = useState([
    ...
    {
      id: 2,
      earningHeading: "Overtime Pay",
      employeeName: "JOHN DOE",
      particular: "Extra hours worked",
      amount: 750,
      monthName: "January",
      yearName: 2025,
      date: "08/08/2025 00:00:00"
    ...
    {
      id: 3,
      earningHeading: "Bonus",
      employeeName: "ADMIN",
      particular: "Performance bonus",
      amount: 1200,
      monthName: "January",
      yearName: 2025,
      date: "08/08/2025 00:00:00"
  ...
  const columns = [
    ...
    {
      header: "Earning Heading",
      accessor: "earningHeading",
    },
    {
