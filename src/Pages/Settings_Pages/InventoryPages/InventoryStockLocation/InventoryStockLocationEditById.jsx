...
const InventoryStockLocationEditById = () => {
  ...
  const onSubmit = (data) => {
    console.log("Stock Location Form Data:", data);
  ...
  return (
    <div className="max-w-6xl min-h-screen mx-auto p-6">
      <div className="flex items-center mb-6">
        <Link
          to="/WorkPeriod/inventory/stock-locations/"
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-yellow-200 to-yellow-400 border-b border-gray-200">
          ...
          <p className="text-gray-700 mt-1">
            Fill in the details below to update the stock location
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <FormInput
                ...
                placeholder="e.g., Tekerhat bazar"
                name="stockLocation"
                register={register}
                rules={{ required: "Stock location name is required" }}
                errors={errors}
              />
            </div>
          </div>
