...
const InventoryStockLocationEditById = () => {
  ...
  if (loading) return <div className="max-w-6xl mx-auto p-6 text-center text-muted-foreground">Loading...</div>;
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
        <div className="p-6 bg-gradient-to-r bg-primary text-primary-foreground border-b border-border">
          <h2 className="text-2xl font-bold text-foreground">Update Stock Location</h2>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          ...
          <div className="mt-8 flex justify-end space-x-3">
            <Link to="/WorkPeriod/inventory/stock-locations" className="px-5 py-2.5 border border-border rounded-lg text-foreground hover:bg-muted/40">Cancel</Link>
