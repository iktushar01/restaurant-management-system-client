...
const WaiterPageIndex = () => {
  ...
  return (
    <div className="p-6   mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 border border-border rounded-md focus:ring-2 focus-visible:ring-ring focus-visible:border-ring"
          />
        </div>
      </div>
      ...
      {loading ? (
        <div className="text-center py-12 text-muted-foreground">Loading waiters...</div>
      ) : (
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-4 text-sm text-foreground">
        ...
        <div className="flex space-x-2 mt-2 md:mt-0">
          <button className="px-3 py-1 border border-border rounded-md bg-muted/40 hover:bg-muted/50">
            Previous
          </button>
          <button className="px-3 py-1 border border-border rounded-md bg-primary/10 text-primary font-medium">
            1
          </button>
          <button className="px-3 py-1 border border-border rounded-md bg-muted/40 hover:bg-muted/50">
            Next
