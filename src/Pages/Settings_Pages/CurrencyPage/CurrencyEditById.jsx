...
const CurrencyEditById = () => {
  ...
  useEffect(() => {
    currencyService
      ...
      .catch((err) => setSubmitError(err.message || "Failed to load currency"))
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setSubmitError(err.message || "Failed to update currency");
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="bg-card rounded-xl border border-border overflow-hidden max-w-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input className="w-full px-4 py-2.5 border border-border rounded-lg"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input className="w-full px-4 py-2.5 border border-border rounded-lg uppercase"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" min="0" max="4" className="w-full px-4 py-2.5 border border-border rounded-lg"
                {...register("decimalPlaces", { required: true })} />
            </div>
          </div>
...
export default CurrencyEditById;
